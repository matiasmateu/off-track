...
const About = () => (
  <Container>
    <View style={{ top: '20%', position: 'absolute', zIndex: 10, opacity: 0.8}}>
      <Content padder>
        <Spacer size={30} />
        <View style={styles.backdropView}>
          ...
          <Text style={{ textAlign: 'center', fontSize: 20 }}>
            ...
            {' '}
            Off-Track invites you to go outside.{'\n'}{'\n'}
            {' '}
    ...
    <MapView
      ...
      region={{latitude: 52.379049, longitude: 4.900315, latitudeDelta: 0.05, longitudeDelta: 0.05}}
...
var styles = StyleSheet.create({
  ...
  backdropView: {
    width: '100%',
    backgroundColor: 'rgba(48,49,69,0.75)',
    padding: 10,
    borderRadius: 5,
    zIndex: 10,
  },
